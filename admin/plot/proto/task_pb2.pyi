...
class Task(_message.Message):
    ...
    def __init__(
        self,
        id: _Optional[str] = ...,
        type: _Optional[_Union[TaskType, str]] = ...,
        sources: _Optional[_Iterable[_Union[Location, _Mapping]]] = ...,
...
class TaskResponse(_message.Message):
    ...
    def __init__(
        self,
        accepted: bool = ...,
        robot_id: _Optional[str] = ...,
        message: _Optional[str] = ...,
        estimated_completion_time: _Optional[int] = ...,
    ) -> None: ...
...
class RobotInfo(_message.Message):
    ...
    def __init__(
        ...
        id: _Optional[str] = ...,
        name: _Optional[str] = ...,
        state: _Optional[_Union[RobotState, str]] = ...,
        current_location: _Optional[_Union[Location, _Mapping]] = ...,
        battery_level: _Optional[float] = ...,
        current_task_id: _Optional[str] = ...,
        last_seen: _Optional[int] = ...,
        entity_id: _Optional[str] = ...,
    ) -> None: ...
...
class RobotDistributionResponse(_message.Message):
    ...
    def __init__(
        self,
        robots: _Optional[_Iterable[_Union[RobotInfo, _Mapping]]] = ...,
        total_count: _Optional[int] = ...,
        idle_count: _Optional[int] = ...,
        busy_count: _Optional[int] = ...,
    ) -> None: ...
...
class Polygon(_message.Message):
    ...
    def __init__(
        self,
        vertices: _Optional[_Iterable[_Union[Point, _Mapping]]] = ...,
        label: _Optional[str] = ...,
        area: _Optional[float] = ...,
        centroid: _Optional[_Union[Point, _Mapping]] = ...,
    ) -> None: ...
...
class PlotExtractionConfig(_message.Message):
    ...
    def __init__(
        self,
        blur_kernel_size: _Optional[float] = ...,
        threshold_value: _Optional[int] = ...,
        threshold_type: _Optional[int] = ...,
        min_area: _Optional[float] = ...,
        max_area: _Optional[float] = ...,
        epsilon_factor: _Optional[float] = ...,
        apply_morphology: bool = ...,
        morph_kernel_size: _Optional[int] = ...,
        use_canny: bool = ...,
        canny_low: _Optional[int] = ...,
        canny_high: _Optional[int] = ...,
    ) -> None: ...
...
class ExtractPolygonsRequest(_message.Message):
    ...
    def __init__(
        self,
        entity_id: _Optional[str] = ...,
        floor_id: _Optional[str] = ...,
        floor_plan: _Optional[_Union[FloorPlanImage, _Mapping]] = ...,
        config: _Optional[_Union[PlotExtractionConfig, _Mapping]] = ...,
    ) -> None: ...
...
class ExtractPolygonsResponse(_message.Message):
    ...
    def __init__(
        self,
        polygons: _Optional[_Iterable[_Union[Polygon, _Mapping]]] = ...,
        total_count: _Optional[int] = ...,
        error: _Optional[str] = ...,
        stats: _Optional[_Union[PlotProcessingStats, _Mapping]] = ...,
    ) -> None: ...
...
class PlotProcessingStats(_message.Message):
    ...
    def __init__(
        self,
        contours_found: _Optional[int] = ...,
        contours_filtered: _Optional[int] = ...,
        processing_time_ms: _Optional[float] = ...,
...
class BatchExtractRequest(_message.Message):
    ...
    def __init__(
        self,
        entity_id: _Optional[str] = ...,
        floor_plans: _Optional[_Iterable[_Union[FloorPlanBatch, _Mapping]]] = ...,
        config: _Optional[_Union[PlotExtractionConfig, _Mapping]] = ...,
    ) -> None: ...
...
class BatchExtractResponse(_message.Message):
    ...
    def __init__(
        self,
        extractions: _Optional[_Iterable[_Union[FloorExtraction, _Mapping]]] = ...,
