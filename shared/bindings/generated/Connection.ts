 ...
 */
export type Connection = { id: string, entity: string, name: string, description: string | null, type: ConnectionType, 
/**
 ...
 */
available_period: Array<[number, number]>, tags: Array<string>, gnd: [number, number] | null, created_at: bigint, updated_at: bigint, };
