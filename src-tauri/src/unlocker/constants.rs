...
pub const DEVICE_BYTES_OFFSET: usize = IDENTIFIER_LENGTH + CHALLENGE_HASH_LENGTH;
pub const VERIFY_BYTES_OFFSET: usize =
    IDENTIFIER_LENGTH + CHALLENGE_HASH_LENGTH + DEVICE_BYTES_LENGTH;
pub const TIMESTAMP_OFFSET: usize =
    IDENTIFIER_LENGTH + CHALLENGE_HASH_LENGTH + DEVICE_BYTES_LENGTH + VERIFY_BYTES_LENGTH;
pub const COUNTER_OFFSET: usize = IDENTIFIER_LENGTH
    + CHALLENGE_HASH_LENGTH
    + DEVICE_BYTES_LENGTH
    + VERIFY_BYTES_LENGTH
    + TIMESTAMP_LENGTH;
pub const SERVER_SIGNATURE_OFFSET: usize = IDENTIFIER_LENGTH
    + CHALLENGE_HASH_LENGTH
    + DEVICE_BYTES_LENGTH
    + VERIFY_BYTES_LENGTH
    + TIMESTAMP_LENGTH
