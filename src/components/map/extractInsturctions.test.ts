...
describe('Extract Instructions', () => {
  it('should extract instructions correctly', () => {
    ...
    let instructions = {"instructions":[{"move":[12.5,38.0]},{"move":[12.5,42.5]},{"move":[2.5,42.5]},{"move":[2.5,55.5]},{"move":[2.5,68.0]},{"transport":["68a834a1bdfa76608b934af0","68a83067bdfa76608b934aeb","elevator"]},{"move":[2.5,68.0]},{"move":[25.0,68.0]}]}
    // @ts-ignore
