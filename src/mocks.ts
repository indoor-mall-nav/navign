...
export const mockMerchants: Merchant[] = [
  ...
  },
  {
    ...
    name: "Starbucks",
    description: "World's largest coffeehouse chain serving coffee, tea, and light snacks",
    chain: "Starbucks",
  ...
  },
  {
    ...
    description: "Your one-stop shop for the latest smartphones, laptops, and tech accessories",
    chain: null,
  ...
  },
  {
    ...
    description: "Authentic Cantonese cuisine with traditional dim sum and modern Chinese dishes",
    chain: null,
    ...
    type: {
      food: {
        ...
        type: { restaurant: { chinese: { cuisine: "cantonese", specific: "Dim Sum" } } }
      }
    },
    ...
    social_media: [
      ...
      {
        platform: "yelp",
        handle: "Golden Dragon Restaurant",
  ...
  },
  {
    ...
    description: "Luxury spa offering massages, facials, and holistic wellness treatments",
    chain: null,
  ...
  },
  {
    ...
    description: "Classic and modern arcade games, pinball machines, and competitive gaming",
    chain: null,
    entity: { $oid: "507f1f77bcf86cd799439006" },
    beacon_code: "GZ-ARC-001",
    area: { $oid: "507f1f77bcf86cd799439105" },
    type: "entertainment",
    tags: ["arcade", "gaming", "pinball", "entertainment", "family-fun", "tournaments"],
  ...
  },
  {
    ...
    name: "Fresh Market",
    description: "Local supermarket with fresh produce, organic options, and everyday essentials",
    chain: null,
  ...
  },
  {
    ...
    description: "Traditional Japanese sushi and sashimi prepared by master chefs",
    chain: null,
  ...
  },
  {
    ...
    description: "Comprehensive healthcare services including general practice and specialty care",
    chain: null,
    entity: { $oid: "507f1f77bcf86cd799439010" },
    beacon_code: "HF-CLINIC-001",
    area: { $oid: "507f1f77bcf86cd799439109" },
    type: "health",
    tags: ["healthcare", "clinic", "general-practice", "specialists", "insurance-accepted"],
