...
pub const DEVICE_RESPONSE_LENGTH: usize = IDENTIFIER_LENGTH + DEVICE_TYPE_LENGTH + DEVICE_CAPABILITY_LENGTH + DEVICE_ID_LENGTH;
...
pub const DEVICE_ID_OFFSET: usize = IDENTIFIER_LENGTH + DEVICE_TYPE_LENGTH + DEVICE_CAPABILITY_LENGTH;
