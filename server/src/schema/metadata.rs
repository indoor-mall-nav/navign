...
mod tests {
    ...
    fn test_pagination_metadata_first_page() {
        ...
        assert_eq!(
            ...
            Some("/api/items?offset=10&limit=10".to_string())
        );
    ...
    fn test_pagination_metadata_middle_page() {
        ...
        assert_eq!(
            metadata.next_page_url,
            Some("/api/items?offset=30&limit=10".to_string())
        );
        assert_eq!(
            metadata.prev_page_url,
            Some("/api/items?offset=10&limit=10".to_string())
        );
    }
    ...
    fn test_pagination_metadata_last_page() {
        ...
        assert_eq!(
            metadata.prev_page_url,
            Some("/api/items?offset=80&limit=10".to_string())
        );
    }
    ...
    fn test_pagination_metadata_zero_offset() {
        ...
        assert_eq!(
            metadata.next_page_url,
            Some("/api/test?offset=20&limit=20".to_string())
        );
    }
    ...
    fn test_pagination_metadata_custom_limit() {
        ...
        assert_eq!(
            metadata.next_page_url,
            Some("/api/custom?offset=30&limit=15".to_string())
        );
        assert_eq!(
            metadata.prev_page_url,
            Some("/api/custom?offset=0&limit=15".to_string())
        );
    }
}
